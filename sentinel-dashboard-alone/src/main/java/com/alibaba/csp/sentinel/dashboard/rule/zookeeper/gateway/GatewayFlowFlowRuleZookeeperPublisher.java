...
@Component("gatewayFlowFlowRuleZookeeperPublisher")
public class GatewayFlowFlowRuleZookeeperPublisher extends RuleZookeeperPublisher<GatewayFlowRuleEntity> {

    @Override
    public String getDataIdPostfix() {
        return ConfigUtil.GATEWAY_FLOW_DATA_ID_POSTFIX;
    }
}