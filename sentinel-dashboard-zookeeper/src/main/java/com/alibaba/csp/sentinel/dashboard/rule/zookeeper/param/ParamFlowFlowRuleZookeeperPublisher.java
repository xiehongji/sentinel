...
@Component("paramFlowFlowRuleZookeeperPublisher")
public class ParamFlowFlowRuleZookeeperPublisher extends RuleZookeeperPublisher<ParamFlowRuleEntity> {

    @Override
    public String getDataIdPostfix() {
        return ConfigUtil.PARAM_FLOW_DATA_ID_POSTFIX;
    }
}