...
@Component("apiDefinitionZookeeperPublisher")
public class ApiDefinitionZookeeperPublisher extends RuleZookeeperPublisher<ApiDefinitionEntity> {

    @Override
    public String getDataIdPostfix() {
        return ConfigUtil.GATEWAY_API_FLOW_DATA_ID_POSTFIX;
    }
}